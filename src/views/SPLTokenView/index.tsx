              ...
              <div className="w-full">
                ...
                <div className="md:w-[600px] mx-auto">
                  <div className="md:w-[480px] flex flex-col m-auto">
                    ...
                    <div className="my-2 uppercase flex font-bold text-2xl">Token infos</div>
                    ...
                    <div className="flex justify-center">
                      {metadataMethod == "url" ?
                        <button
                          className="text-white mx-2  font-semibold bg-[#343e4f] md:w-[280px] rounded-full shadow-xl border">Use
                          an existing medatata URL</button>
                        : <button
                          ...
                          }}>Use an existing medatata URL</button>
                      }
                      {metadataMethod == "upload" ?
                        <button
                          className="text-white mx-2 font-semibold bg-[#343e4f] md:w-[200px] rounded-full shadow-xl border"
                        >Create
                          the metadata</button>
                        : <button
                          className="text-white mx-2 font-semibold bg-[#667182] md:w-[200px] rounded-full shadow-xl border"
                          onClick={() => {
                            setMetadataMethod("upload"), setMetadataURL(""), setFile(undefined), setFileName("");
                  ...
                  <CreateTokenButton connection={connection} publicKey={publicKey} wallet={wallet} quantity={quantity}
                                     decimals={decimals} isChecked={isChecked} tokenName={tokenName} symbol={symbol}
                                     metadataURL={metadataURL} description={tokenDescription} file={file}
